...
class Config:
    ...
    @property
    def data_file(self):
        return os.path.join(BASE_DIR, '../..',  'dataset/Anthem_dataset', self.config['Data']['data_file'])

    @property
    def test_file(self):
        return os.path.join(BASE_DIR, '../..', 'dataset/Anthem_dataset', self.config['Data']['test_file'])
